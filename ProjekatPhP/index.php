...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <?php }else{?>
                    <li class="nav-item">
                    <a class="btn btn-outline-primary" href="Prijava.php">Prijavi se</a>
                    </li>
                <?php }?>
            </ul>
        </div>
    ...
    <?php if(isset($_SESSION['registrovan'])) {
        if($_SESSION['email']=="markomarkovic@gmail.com"){
            ?>
                ...
                <div class="overlay"></div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 text-center">
                            <h1 class="display-4 text-white">Dobrodošlica našem adminu!</h1>
    ...
    <div class="row">
            ...
            <div class="col-md-4 mb-4" v-for="event in events">
                <div class="card h-100">
                    <img src="Slike/Marko.webp" class="card-img-top" alt="Event Image">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4" v-for="event in events">
                <div class="card h-100">
                    <img src="Slike/Jelena.jpg" class="card-img-top" alt="Event Image">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4" v-for="event in events">
                <div class="card h-100">
                    <img src="Slike/Milan.jpg" class="card-img-top" alt="Event Image">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4" v-for="event in events">
                <div class="card h-100">
                    <img src="Slike/Ana.jpg" class="card-img-top" alt="Event Image">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4" v-for="event in events">
                <div class="card h-100">
                    <img src="Slike/Ivana.webp" class="card-img-top" alt="Event Image">
                    <div class="card-body">
